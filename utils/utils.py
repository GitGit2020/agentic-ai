...
def load_and_prepare_gapminder(year: int | None = None) -> pd.DataFrame:
    """
    Load the Gapminder dataset and optionally filter by year.

    This mirrors the behavior of load_and_prepare_data():
    - returns a clean DataFrame
    - keeps column names explicit
    - ready for charting and schema inspection
    """
